    ...
    <Row class="page3">
        ...
        <Col style="width:48%;padding:0 1%;">
            ...
            <div class="center-bottom">
                <span class='title'><span class="title-text">评论热度分析</span></span>
                <!-- <span class="angle1"></span>
                <span class="angle2"></span>
                <span class="angle3"></span>
                <span class="angle4"></span>
                ...
                <single-area-chart  :selectRangeDate="selectRangeDate" ></single-area-chart>
            </div>
        </Col>
        <Col style="width:26%">
            <div class="right-1">
                <div class="right1-1">
                    <span class='title'><span class="title-text">商家热度排行</span></span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
                    <span class="angle4"></span>
            ...
            <div class="right-2">
                <div class="right1-1">
                    <span class='title'><span class="title-text">积极/消极词汇分析</span></span>
                    <span class="angle1"></span>
                    <span class="angle2"></span>
                    <span class="angle3"></span>
                    <span class="angle4"></span>
